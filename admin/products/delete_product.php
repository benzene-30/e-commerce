            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if (!empty($image) || $image === "") { //Shows 1 if the image was uploaded successfully
                            $image_flag = 1;
                            ...
                            echo '<tr>
                                ...
                                <td class="btn-data-info">
                                    <button class="btn-danger"><a href="delete_item.php?deleteid=' . $id . '" class="text-light">Delete</a></button>
                                </td>
